...
- **Navigation Management**  
  - Stack navigation with proper screen unmounting to avoid map crashes  
  - Screens detach correctly to ensure MapView resets when re-entered
...
**Resto** is a **location-aware restaurant discovery app**. Restaurants are mocked but dynamically update according to the user’s location. The app efficiently handles geolocation, map rendering, and navigation, providing a realistic, interactive experience and a solid foundation for production-ready location-based apps.
